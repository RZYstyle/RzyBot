...
/////////////////
const BotName = 'RZY BOT☄'; 
const instagram = 'https://instagram.com/rzy.style'; 
const telegram = 'https://t.me/Rizqyajaaa'; 
...
conn.on('user-presence-update', json => console.log(json.id + ' presence is => ' + json.type)) || console.log('Bot by ig:@rzy.style')
conn.on('message-status-update', json =>
{
   const participant = json.participant ? ' (' + json.participant + ')' : '' // participant exists when the message is from a group
   console.log(`[ ${moment().format("HH:mm:ss")} ] => bot by ig:@rzy.style`)
})
